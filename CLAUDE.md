...
- **HTTP client**: reqwest 0.12 with json feature (pinned by teloxide-core 0.13 — do NOT upgrade to 0.13 until teloxide supports it)
...
| reqwest | 0.12 | Pinned by teloxide-core 0.13 |
